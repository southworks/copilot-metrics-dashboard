...
import { getCopilotMetrics, IFilter as MetricsFilter } from "@/services/team-copilot-metrics-service";
...
export default async function TeamDashboard(props: IProps) {
  const allDataPromise = getCopilotMetrics(props.searchParams, "team-copilot");

...
import { ActiveUserData, getActiveUsers } from "./team-common";
...
export const ActiveUsers = () => {
  ...
  return (
    <Card className="col-span-4">
      <ChartHeader
        title="Active Users"
        description="The total number active and engaged users per day using the chat and inline suggestions."
      />
      <CardContent>
        <ChartContainer config={chartConfig} className="w-full h-80">
          <BarChart accessibilityLayer data={data}>
            ...
            />{" "}
            <Bar
              dataKey={chartConfig.totalEngagedUsers.key}

...
import { ListItems } from "./team-language";
...
import { computeEditorData } from "./team-common";
      ...
      <Tooltip.Root delayDuration={0}>
        ...
        >
          <div
            ...
            className="px-4 py-2"
          >
            The percentages for each editor are calculated by aggregating the
            number of active users for each editor across all data points. The

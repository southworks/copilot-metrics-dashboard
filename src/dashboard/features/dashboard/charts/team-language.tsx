...
import { computeLanguageData } from "./team-common";
      ...
      <Tooltip.Root delayDuration={0}>
        ...
        >
          <div
            ...
            className="px-4 py-2"
          >
            The percentages for each language are calculated by aggregating the
            number of active users for each language across all data points. The
